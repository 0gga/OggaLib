...
void csvlog_test() {
	...
	ogga::csv_log minutelyLog(ogga::csv_log::minutely("minutelyLogs"), "status", "message");
	minutelyLog.log("INFO", "It's Alive!");
	minutelyLog.log("WARNING", "Nah just kidding.");

	ogga::csv_log hourlyLog(ogga::csv_log::hourly("hourlyLogs"), "status", "message");
	...
	ogga::csv_log monthlyLog(ogga::csv_log::monthly("monthlyLogs"), "status", "message");
